...
// ================= BASE =================
const resepBaseSchema = z.object({
...
// ================= FINAL =================
export const resepSchema = resepBaseSchema.refine(
...
// ================= DETAIL =================
const resepDetailBaseSchema = z.object({
...
export const resepDetailSchema = resepDetailBaseSchema.refine(
  (data) => data.qty > 0,
...
// ================= WITH DETAILS =================
export const resepWithDetailsSchema = resepBaseSchema.extend({
